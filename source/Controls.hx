...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		{
			case Solo:
				inline bindKeys(Control.UP, [K, W, FlxKey.UP]);
				inline bindKeys(Control.DOWN, [J, S, FlxKey.DOWN]);
				inline bindKeys(Control.LEFT, [H, A, FlxKey.LEFT]);
				inline bindKeys(Control.RIGHT, [L, D, FlxKey.RIGHT]);
